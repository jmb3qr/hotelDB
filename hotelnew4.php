...
-------------------------------------------------- */
.jumbotron {
  background-image:url("http://www.loggia.gr/new/assets/files/images/pages/page_galleries/srh03.jpg");
            /*900 by 400*/
  height: 400px;
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <li><a href="hotelnew4.php#Contact" >Contact Us</a></li>
          </ul>
        </div>
...
<div class="container marketing">
  ...
  <!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
      <div class="container">
        <h2 class="featurette-heading">Courtyard Hotel</h2>
      </div>
    </div>
