...
-------------------------------------------------- */
.jumbotron {
  background-image:url("http://www.foursomethings.com/sites/default/files/styles/top_banner/public/images/venues/49-Highlands%20Ranch%20Mansion/49-about-new1.jpg?itok=UjWiiRxn");
            /*900 by 400*/
  height: 400px;
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <li><a href="hotelnew6.php#Contact" >Contact Us</a></li>
          </ul>
        </div>
...
<div class="container marketing">
  ...
  <!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
      <div class="container">
        <h2 class="featurette-heading">Hartford House</h2>
      </div>
    </div>
...
<p><button type="button" class="btn btn-default" data-dismiss="modal" onclick="window.open('checkguest.php', 'newwindow', 'width=400, height=500'); return false;" >Reserve</button></p>      
  ...
  <p><center>Hartford House	</p>
   <p>Pennsylvania Way	</p>
    <p>Fairview, CT 22525 </p>
