...
<html lang="en">
        ...
        <meta charset="utf-8">
        <title>Casino Royale Hotel</title>
...
-------------------------------------------------- */
.jumbotron {
  background-image:url("https://www.saccocarpet.com/img/projects/Rockwell%20Group_The%20Palm%20Casino.jpg");
            /*900 by 400*/
  height: 400px;
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <li><a href="hotelnew2.php#Contact" >Contact Us</a></li>
          </ul>
        </div>
...
<div class="container marketing">
  ...
  <!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
      <div class="container">
        <h2 class="featurette-heading">Casino Royale</h2>
      </div>
    </div>
