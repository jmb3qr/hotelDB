...
-------------------------------------------------- */
.jumbotron {
  background-image:url("http://www.hardrockhotelsd.com/files/1629/Accessible.jpg");
            /*900 by 400*/
  height: 400px;
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <li><a href="hotelnew5.php#Contact" >Contact Us</a></li>
          </ul>
        </div>
...
<div class="container marketing">
  ...
  <!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="jumbotron">
      <div class="container">
        <h2 class="featurette-heading">Sleep Inn</h2>
      </div>
    </div>
...
<p><button type="button" class="btn btn-default" data-dismiss="modal" onclick="window.open('checkguest.php', 'newwindow', 'width=400, height=500'); return false;" >Reserve</button></p>      
  ...
  <p><center>Sleep Inn	</p>
   <p>Washington Ave	</p>
    <p>Seattle WA, 33042 </p>
