...
<div class="container marketing">
  ...
  <div class="featurette">
    <img class="featurette-image img-circle pull-right" src="assets/beach.jpg">
    <h2 class="featurette-heading">Beach Palm Hotel</h2>
    <p class="lead">A beautiful hotel on the beach in Charleston. With access to the beach, you'll feel like a part of our great city </p>
  </div>
...
<div class="row">
  ...
  <!-- /END THE FEATURETTES -->
<h3 class="featurette-heading">Make a Reservation</h3>
  <br>
    <br>
    <br>
